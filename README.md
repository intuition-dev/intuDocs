...
This is the basics and intro to MetaBake. You can see it helps with html, .js, .css, and json. You can use use these basic features to help you write any web-app.
