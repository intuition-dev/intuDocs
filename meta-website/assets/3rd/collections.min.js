// v5.02.19 on 2019-03-20T21:12:58.595Z
!function(f) {
 ...
 return function() {
  ...
  5: [ function(require, module, exports) {
   (function(global) {
    ...
    GlobalSet.prototype.reduce = function(callback, basis) {
     ...
     for (var value, thisp = arguments[2], setIterator = this.values(), size = this.size, reverseOrder = new Array(this.size), i = 0; value = setIterator.next().value; ) {
  ...
  24: [ function(require, module, exports) {
   (function(global) {
    "use strict";
    var GlobalSet, Set = require("./_set"), PropertyChanges = require("./listen/property-changes"), RangeChanges = require("./listen/range-changes"), MapChanges = require("./listen/map-changes");
    if (void 0 !== global.Set && "function" == typeof global.Set.prototype.values) {
     ...
     var set_clear = GlobalSet.prototype.clear, set_add = GlobalSet.prototype.add, set_delete = GlobalSet.prototype.delete, observableSetProperties = {
      ...
      clear: {
       value: function() {
        var clearing;
        this.dispatchesRangeChanges && (clearing = this.toArray(), this.dispatchBeforeRangeChange(this._dispatchEmptyArray, clearing, 0)), 
        set_clear.call(this), this.dispatchesRangeChanges && this.dispatchRangeChange(this._dispatchEmptyArray, clearing, 0);
       },
       writable: !0,
       configurable: !0
      },
      add: {
       value: function(value) {
        if (!this.has(value)) {
         ...
         return this.dispatchesRangeChanges && this.dispatchBeforeRangeChange(dispatchValueArray, this._dispatchEmptyArray, index), 
    ...
    function setupCollectionSet() {
     ...
     Object.defineProperty(CollectionsSet.prototype, "_dispatchEmptyArray", {
      ...
      if (this.store.has(node)) {
       ...
       var dispatchValueArray = [ value ];
       return this.dispatchesRangeChanges && this.dispatchBeforeRangeChange(this._dispatchEmptyArray, dispatchValueArray, node.index), 
      ...
      var clearing;
      this.dispatchesRangeChanges && (clearing = this.toArray(), this.dispatchBeforeRangeChange(this._dispatchEmptyArray, clearing, 0)), 
      this._clear(), this.dispatchesRangeChanges && this.dispatchRangeChange(this._dispatchEmptyArray, clearing, 0);
  ...
  27: [ function(require, module, exports) {
   ...
   module.exports = Object, Object.empty = Object.freeze(Object.create(null)), Object.isObject = function(object) {
