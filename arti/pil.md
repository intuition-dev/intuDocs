...
- http://github.com/MetaBake/MetaBake-examples/tree/master/examples/crud
or you can run it by installing a low-code static generator mbake from here:
- http://www.staticgen.com/MetaBakeorg
and then 
   mbake -c
