...
The Chrome extension that lets you hot-link edit an INTU.DEV screen, such as our example CRUD app is here:
...
If you install our browser extension, you can edit any screen|page that has been developed in INTU.DEV. 
